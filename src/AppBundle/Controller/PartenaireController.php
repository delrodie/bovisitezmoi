...
class PartenaireController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em->flush();
            $this->addFlash('notice', "Le partenaire <strong>".$partenaire->getNom()."</strong> a été ajouté avec succès!");
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('backend_partenaire_show', array('id' => $partenaire->getId()));
        }
     ...
     *
     * @Route("/{slug}", name="backend_partenaire_show")
     * @Method("GET")
     */
